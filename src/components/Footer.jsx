...
function Footer() {
  return (
    <div className=" w-full  flex  bg-cyan-900 ">
      <div className=" w-1/2  flex  flex-col h-full px-10 py-14 font-bold justify-between  tracking-tighter leading-none text-white text-[6vw] ">
        <h1>EYE-</h1>
        <h1>OPENING</h1>
      ...
      <div className=" w-1/2  px-10 py-14  ">
        <h1 className="font-bold   tracking-tighter leading-none text-white text-[6vw]">
          PRASENTION
        </h1>
        <div className="  mt-64 text-slate-100 ">
          <a className=" block text-2xl font-medium" href="Instagram">
            Instagra
          </a>
          <a className=" block text-2xl font-medium" href="Facebook">
            Facebook
          </a>
          <a className=" block text-2xl font-medium" href="Wahatsap">
            Whatsap
          </a>
        </div>
      </div>
